...
*** Variable ***
${SOSMED_LOGIN_BUTTON}            .js-tel-social-login
${DROPDOWN_USER}                  .bl-avatar.sigil-avatar
${LOGOUT}                         .bl-list-item__title
${LOGIN}                          .sigil-header__nav.te-header-login
...
Logout
    Sleep                                    0.5
    Click Element                            sizzle=${DROPDOWN_USER}
    sleep                                    1
    Click Element                            sizzle=${LOGOUT}:contains("Logout")
    #Keywords.Verify Page After Logout
    sleep                                    1

Verify Page After Logout
    Sleep                                    5
    #Page Should Not Contain Element          sizzle=${DROPDOWN_USER}
    Wait Until Element Is Visible            sizzle=${LOGIN}                                                   timeout=15
    Location Should Be                       ${HOME URL}

###################### USER MENU ##########################
Check Drop Down Menu
    Wait Until Element Is Visible            sizzle=${DROPDOWN_USER}                                           timeout=30
    #Location Should Contain                  ${HOME URL}/fb_login
